  ...
  style: defaults<MapToType<PathStyleProps, boolean>, MapToType<PathStyleProps, boolean>>(
    {
      ...
      lineWidth: true,
      miterLimit: true
    } as MapToType<PathStyleProps, boolean>,
...
const pathCopyParams = (TRANSFORMABLE_PROPS as readonly string[]).concat([
  'invisible',
  'culling',
  'z',
  'z2',
